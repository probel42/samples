 ...
 * 2. Я перегоняю все слова в словаре в lowercase.
 * 3. В маске не может быть "дырки". Отдельной ячейки не соприкасающейся с остальными. Это валидируется.
 * 4. С голым полем 7x7 справляется не очень, но это и не удивительно.
 * 5. Рядом файл words.txt со словарём, слова там иногда немного странные.
 * 6. node crossword.js < input.txt
 *
 *
 * Описание решения:
 *
